...
***SG_01_1_No_PolAcc=VALUE(SG_01_1_e)+VALUE(SG_01_1_f)+VALUE(SG_01_1_g)+VALUE(SG_01_1_h)+VALUE(SG_01_1_i)+VALUE(SG_01_1_j)+VALUE(SG_01_1_k)
***SG_01_1_AUMAcc=VALUE(SG_01_1_all)+VALUE(SG_01_1_maj)
***SG_01_1_No_AUMAcc=VALUE(SG_01_1_min)
***SG_01_SCORE=VALUE(
IF(((((SG_01_1_PolAcc)>=100)AND((SG_01_1_No_PolAcc)>=200))OR((SG_01_1_PolAcc>=200)AND(SG_01_1_No_PolAcc<=100)))AND(SG_01_1_AUMAcc=100), 3,
IF((((SG_01_1_ak_SUM)>=200)AND((SG_01_1_AUMAcc)=100))OR(((SG_01_1_ak_SUM)>=300)AND(SG_01_1_min=100)), 2,
IF((((SG_01_1_ak_SUM)=100)AND((SG_01_1_AUMAcc)=100))OR((SG_01_1_ak_SUM=200)AND(SG_01_1_min=100)), 1, 0)
)))
...
***SG_07_Board=RESPONSE(" Q. Board members or trustees", "76885bff75ae471db73361eef76326b6", SURVEY_ID)
***SG_07_Board_O=IFBLANK(SCORE("Q. Oversight/accountability for responsible investment", "44a1ff77e58c4ca3b1b743dfa9a9eec6", SURVEY_ID),0)
***SG_07_Board_I=IFBLANK(SCORE(" Q. Implementation of responsible investment", "9cd5b1af6aab4f2d82fb2ad0bf1858a3", SURVEY_ID),0)
***SG_07_Board_N=IFBLANK(SCORE(" .Q. No oversight/accountability or implementation responsibility for responsible investment", "aeec6dd7709646e6a293bfc8d072ce19", SURVEY_ID),0)
***SG_07_CEO=RESPONSE(" Q. Chief Executive Officer (CEO), Chief Investment Officer (CIO), Investment Committee", "3e2b7202e1b34953b5751521539e8e13", SURVEY_ID)
***SG_07_CEO_O=IFBLANK(SCORE(" Q. Oversight/accountability for responsible investment", "44a1ff77e58c4ca3b1b743dfa9a9eec6_1", SURVEY_ID),0)
***SG_07_CEO_I=IFBLANK(SCORE(" Q. Implementation of responsible investment", "9cd5b1af6aab4f2d82fb2ad0bf1858a3_1", SURVEY_ID),0)
***SG_07_ CEO_N=IFBLANK(SCORE(" Q. No oversight/accountability or implementation responsibility for responsible investment", "0bfcdfa4b7764306b6ae569281775cc2", SURVEY_ID),0)
***SG_07_Clevel=RESPONSE(". Q. Other Chief-level staff or head of department, specify", "ab4b0a289d464465a2bbedcef379086f", SURVEY_ID)
...
***SG_07_Clevel_I=IFBLANK(SCORE(". Q. Implementation of responsible investment", "9cd5b1af6aab4f2d82fb2ad0bf1858a3_2", SURVEY_ID),0)
***SG_07_Clevel_N=IFBLANK(SCORE(" Q. No oversight/accountability or implementation responsibility for responsible investment", "b556a89d18274622991dc8f2af639d66", SURVEY_ID),0)
***SG_07_PM=RESPONSE(" Q. Portfolio managers", "b44a17cc3d5a40b5a0f2826fdb270b91", SURVEY_ID)
***SG_07_PM_O=IFBLANK(SCORE(" Q. Oversight/accountability for responsible investment", "44a1ff77e58c4ca3b1b743dfa9a9eec6_3", SURVEY_ID),0)
***SG_07_PM_I=IFBLANK(SCORE(". Q. Implementation of responsible investment", "9cd5b1af6aab4f2d82fb2ad0bf1858a3_3", SURVEY_ID),0)
***SG_07_PM_N=IFBLANK(SCORE(" Q. No oversight/accountability or implementation responsibility for responsible investment", "20b1e4805cef4982a9b7acaa8bfb9a56", SURVEY_ID),0)
***SG_07_IA=RESPONSE(". Q. Investment analysts", "eee8b5da92c14a7eaf3078313869923f", SURVEY_ID)
***SG_07_IA_O=IFBLANK(SCORE(". Q. Oversight/accountability for responsible investment", "44a1ff77e58c4ca3b1b743dfa9a9eec6_4", SURVEY_ID),0)
...
***SG_07_ESGPM=RESPONSE("PRI reporting framework 2018: (SG_07.1_A5__Esg_Portfolio_Manager) [Choice]ESG portfolio manager", "145ad08ab344489e809f47282d504c0d", SURVEY_ID)
***SG_07_ESGPM_O=IFBLANK(SCORE("PRI reporting framework 2018: (SG_07.1_A5_a1__Oversight_Accountability_For_Responsible_Investment) [Choice]Oversight/accountability for responsible investment", "44a1ff77e58c4ca3b1b743dfa9a9eec6_10", SURVEY_ID), 0)
***SG_07_ESGPM_I=IFBLANK(SCORE("PRI reporting framework 2018: (SG_07.1_A5_a2__Implementation_Of_Responsible_Investment) [Choice]Implementation of responsible investment", "9cd5b1af6aab4f2d82fb2ad0bf1858a3_10", SURVEY_ID),0)
***SG_07_ESGPM_N=IFBLANK(SCORE("PRI reporting framework 2018: (SG_07.1_A5_a3__No_Oversight_Accountability_Implementation_Responsibility_Responsible_Investment) [Exclusive]No oversight/accountability or implementation responsibility for responsible investment", "20b1e4805cef4982a9b7acaa8bfb9a56_1", SURVEY_ID),0)
***SG_07_Oversight_SUM=VALUE(SG_07_Board_O)+VALUE(SG_07_CEO_O)+VALUE(SG_07_Clevel_O)+VALUE(SG_07_PM_O)+VALUE(SG_07_IA_O)+VALUE(SG_07_RI_O)+VALUE(SG_07_EM_O)+VALUE(SG_07_IR_O)+VALUE(SG_07_Other1_O)+ VALUE(SG_07_Other2_O)+VALUE(SG_07_ESGPM_O)
***SG_07_Oversight_SUM2=VALUE(SG_07_Board_O)+VALUE(SG_07_CEO_O)+VALUE(SG_07_Clevel_O)
***SG_07_Oversight_SUM3=VALUE(SG_07_PM_O)+VALUE(SG_07_IA_O)+VALUE(SG_07_RI_O)+VALUE(SG_07_EM_O)+VALUE(SG_07_IR_O)+VALUE(SG_07_Other1_O)+ VALUE(SG_07_Other2_O)+VALUE(SG_07_ESGPM_O)
...
***SG_07_Implementation_SUM=VALUE(SG_07_Board_I)+VALUE(SG_07_CEO_I)+VALUE(SG_07_Clevel_I)+VALUE(SG_07_PM_I)+VALUE(SG_07_IA_I)+VALUE(SG_07_RI_I)+VALUE(SG_07_EM_I)+VALUE(SG_07_IR_I)+VALUE(SG_07_Other1_I)+VALUE(SG_07_Other2_I)+VALUE(SG_07_ESGPM_I)
...
***SG_07_C_Y=IF((SG_07_CEO_O<>"")OR(SG_07_CEO_O<>""),1,0)
...
***SG_10_Y_c=IFBLANK(SCORE("PRI reporting framework 2018 Version 5 (Template - 3 surveys): (SG_10.2_I) [Choice]Provided input and/or collaborated with academia on RI related work", "723663eb7ace4a9e8bcff3f5d8b11bd2", SURVEY_ID),0)
***SG_10_Y_d=IFBLANK(SCORE("PRI reporting framework 2013/2014: (1.2.1.5.2.2.1.1.1.3) . . . . . . . . . . Q. Encouraged better transparency and disclosure of responsible investment practices across the investment industry", "8eb3ddb05a0d4bb2b1933ea47a62c81c", SURVEY_ID),0)
***SG_10_Y_e=IFBLANK(SCORE("PRI reporting framework 2013/2014: (1.2.1.5.2.2.1.1.1.4) . . . . . . . . . . Q. Spoke publicly at events and conferences to promote responsible investment", "a63d785437df45858d84352489cb85cf", SURVEY_ID),0)
***SG_10_Y_f=IFBLANK(SCORE("PRI reporting framework 2013/2014: (1.2.1.5.2.2.1.1.1.5) . . . . . . . . . . Q. Wrote and published in-house research papers on responsible investment", "361ee29275ef4bcb81a9ff506b198ce6", SURVEY_ID),0)
***SG_10_Y_g=IFBLANK(SCORE("PRI reporting framework 2013/2014: (1.2.1.5.2.2.1.1.1.6) . . . . . . . . . . Q. Encouraged the adoption of the PRI", "4663e75f6d2f44cd9805b9a0de546ff9", SURVEY_ID),0)
***SG_10_Y_h=IFBLANK(SCORE("PRI reporting framework 2018 Version 5 (Template - 3 surveys): (SG_10.2_L) [Choice]Responded to RI related consultations by non-governmental organisations (OECD, FSB etc.)", "572351eca5bb4ff3a633a15b0720b0b0", SURVEY_ID),0)
***SG_10_Y_i=IFBLANK(SCORE("PRI reporting framework 2016: (SG_10.2_G) Q Wrote articles on responsible investment in the media. [Choice]", "7e2d79ab04ed4fe8b746b7243c1d224d", SURVEY_ID),0)
***SG_10_Y_j=IFBLANK(SCORE("PRI reporting framework 2018 Version 5 (Template - 3 surveys): (SG_10.2_J) [Choice]A member of PRI advisory committees/ working groups, specify", "9c02109c81104633b985b0d346bf8419", SURVEY_ID),0)
***SG_10_Y_k=IFBLANK(SCORE("PRI reporting framework 2018 Version 5 (Template - 3 surveys): (SG_10.2_K) [Choice]On the Board of, or officially advising, other RI organisations (e.g. local SIFs)", "16e7afdca7c44603ac7e74342fea2389", SURVEY_ID),0)
***SG_10_Y_l=IFBLANK(SCORE("PRI reporting framework 2016: (SG_10.2_H) Q Other, specify [Choice]", "25d0fb35432c441984923b7f0d459840", SURVEY_ID),0)
***SG_10_N=IFBLANK(SCORE("PRI reporting framework 2016: (SG_10.1_B) Q No [Choice]", "994a3af451724ca7a8299cc7a903aade", SURVEY_ID),0)
***SG_10_sum=VALUE(SG_10_N)+VALUE(SG_10_Y_a)+VALUE(SG_10_Y_b)+VALUE(SG_10_Y_c)+VALUE(SG_10_Y_d)+VALUE(SG_10_Y_e)+VALUE(SG_10_Y_f)+VALUE(SG_10_Y_g)+VALUE(SG_10_Y_h)+VALUE(SG_10_Y_i)+VALUE(SG_10_Y_j)+VALUE(SG_10_Y_k)+VALUE(SG_10_Y_l)
***SG_10_SCORE=VALUE(
IF((SG_10_sum)<100, "0",
IF((SG_10_sum)<300, "2",
IF((SG_10_sum)>=300, "3",))
...
***SG_14.1_A=SCORE("PRI reporting framework 2018: (SG_14.2_A1__Changing_Demographics) [Choice]Changing demographics", "d4ed96853fc246f199f4363ad3aa68a1_1", SURVEY_ID)
***SG_14.1_B=SCORE("PRI reporting framework 2018: (SG_14.2_A2__Climate_Change_And_Related_Issues) [Choice]Climate change and related issues", "d4ed96853fc246f199f4363ad3aa68a1_2", SURVEY_ID)
***SG_14.2_A=SCORE("PRI reporting framework 2018: (SG_14.3_A1__Established_Climate_Change_Sensitive_Climate_Change_Integrated_Asset_Allocation_Strategy) [Choice]Established a climate change sensitive or climate change integrated asset allocation strategy", "f05af9cc79594ef88413227ccfc0d1c2_6", SURVEY_ID)
***SG_14.2_B=SCORE("PRI reporting framework 2018: (SG_14.3_A2__Targeted_Low_Carbon_Climate_Resilient_Investments) [Choice]Targeted low carbon or climate resilient investments", "f05af9cc79594ef88413227ccfc0d1c2_7", SURVEY_ID)
***SG_14.2_C=SCORE("PRI reporting framework 2018: (SG_14.3_A3__Reduced_Portfolio_Exposure_Emissions_Intensive_Fossil_Fuel_Holdings) [Choice]Reduced portfolio exposure to emissions intensive or fossil fuel holdings", "f05af9cc79594ef88413227ccfc0d1c2_8", SURVEY_ID)
***SG_14.2_D=SCORE("PRI reporting framework 2018: (SG_14.3_A4__Used_Emissions_Data_Analysis_Inform_Investment_Decision_Making) [Choice]Used emissions data or analysis to inform investment decision making", "f05af9cc79594ef88413227ccfc0d1c2_9", SURVEY_ID)
***SG_14.2_E=SCORE("PRI reporting framework 2018: (SG_14.3_A5__Sought_Climate_Change_Integration_Companies) [Choice]Sought climate change integration by companies", "f05af9cc79594ef88413227ccfc0d1c2_10", SURVEY_ID)
***SG_14.2_F=SCORE("PRI reporting framework 2018: (SG_14.3_A6__Sought_Climate_Supportive_Policy_Governments) [Choice]Sought climate supportive policy from governments", "f05af9cc79594ef88413227ccfc0d1c2_11", SURVEY_ID)
***SG_14.2_G=SCORE("PRI reporting framework 2018: (SG_14.3_A7__Other_Specify) [Choice]Other, specify", "7c1d0c2bbf714b168485ca78696c21e0_1", SURVEY_ID)
***SG_14.2_H=SCORE("PRI reporting framework 2018: (SG_14.3_A8__None_Of_The_Above) [Exclusive]None of the above", "8ee5589c321346cd8d8c3a203abfb762_1", SURVEY_ID)
***SG_14.3_A=SCORE("PRI reporting framework 2018: (SG_14.4_A1__Scenario_Analysis) [Choice]Scenario analysis", "f05af9cc79594ef88413227ccfc0d1c2_2", SURVEY_ID)
***SG_14.3_B=SCORE("PRI reporting framework 2018: (SG_14.4_A2__Disclosure_Emissions_Risk_Clients_Trustees_Management_Beneficiaries) [Choice]Disclosure on emissions risk to clients/trustees/management/beneficiaries", "f05af9cc79594ef88413227ccfc0d1c2_3", SURVEY_ID)
***SG_14.3_C=SCORE("PRI reporting framework 2018: (SG_14.4_A3__Climate_Related_Targets) [Choice]Climate-related targets", "90e4c4c4fe394b4198e2327608451ac4", SURVEY_ID)
***SG_14.3_D=SCORE("PRI reporting framework 2018: (SG_14.4_A4__Encourage_Internal_External_Portfolio_Managers_Monitor_Emissions_Risk) [Choice]Encourage internal and/or external portfolio managers to monitor emissions risk", "f05af9cc79594ef88413227ccfc0d1c2_5", SURVEY_ID)
***SG_14.3_E=SCORE("PRI reporting framework 2018: (SG_14.4_A5__Emissions_Risk_Monitoring_Reporting_Formalised_Contracts_Appointing_Managers) [Choice]Emissions risk monitoring and reporting are formalised into contracts when appointing managers", "f05af9cc79594ef88413227ccfc0d1c2", SURVEY_ID)
***SG_14.3_F=SCORE("PRI reporting framework 2018: (SG_14.4_A6__Weighted_Average_Carbon_Intensity) [Choice]Weighted average carbon intensity", "23c997a1c76e4bd49fe63a02de3f8aa1", SURVEY_ID)
***SG_14.3_G=SCORE("PRI reporting framework 2018: (SG_14.4_A7__Carbon_Footprint_Scope_1_2) [Choice]Carbon footprint (scope 1 and 2)", "f05af9cc79594ef88413227ccfc0d1c2_1", SURVEY_ID)
***SG_14.3_H=SCORE("PRI reporting framework 2018: (SG_14.4_A8__Portfolio_Carbon_Footprint) [Choice]Portfolio carbon footprint", "e981308cc0624a2cbfac76ac1aa89af2", SURVEY_ID)
***SG_14.3_I=SCORE("PRI reporting framework 2018: (SG_14.4_A9__Total_Carbon_Emissions) [Choice]Total carbon emissions", "1dae98978db34fc0bfb735d253f39bfe", SURVEY_ID)
***SG_14.3_J=SCORE("PRI reporting framework 2018: (SG_14.4_A10__Carbon_Intensity) [Choice]Carbon intensity", "c8ed48fda872415681e012e3cc9569c8", SURVEY_ID)
***SG_14.3_K=SCORE("PRI reporting framework 2018: (SG_14.4_A11__Exposure_To_Carbon_Related_Assets) [Choice]Exposure to carbon-related assets", "5f297f6f6b11453fa46e03fae2d58ebb", SURVEY_ID)
***SG_14.3_L=SCORE("PRI reporting framework 2018: (SG_14.4_A12__Other_Emissions_Metrics) [Choice]Other emissions metrics", "f05af9cc79594ef88413227ccfc0d1c2_21", SURVEY_ID)
***SG_14.3_M=SCORE("PRI reporting framework 2018: (SG_14.4_A13__Other_Specify) [Choice]Other, specify", "7c1d0c2bbf714b168485ca78696c21e0", SURVEY_ID)
***SG_14.3_N=SCORE("PRI reporting framework 2018: (SG_14.4_A14__None_Of_The_Above) [Exclusive]None of the above", "8ee5589c321346cd8d8c3a203abfb762", SURVEY_ID)
***SG_14.1_C=SCORE("PRI reporting framework 2017: (SG_13.1_C) Q Resource scarcity [Choice]", "d4ed96853fc246f199f4363ad3aa68a1_3", SURVEY_ID)
***SG_14.1_D=SCORE("PRI reporting framework 2017: (SG_13.1_D) Q Technology developments [Choice]", "d4ed96853fc246f199f4363ad3aa68a1_4", SURVEY_ID)
***SG_14.1_G=SCORE("PRI reporting framework 2017: (SG_13.1_G) Q None of the above [Exclusive]", "31306cba5d0e483eb285d92110893564", SURVEY_ID)
***SG_14.2_SUM=VALUE(SG_14.2_A)+VALUE(SG_14.2_B)+VALUE(SG_14.2_C)+VALUE(SG_14.2_D)+VALUE(SG_14.2_E)+VALUE(SG_14.2_F)
***SG_14.3_SUM=VALUE(SG_14.3_A)+VALUE(SG_14.3_B)+VALUE(SG_14.3_C)+VALUE(SG_14.3_D)+VALUE(SG_14.3_E)+VALUE(SG_14.3_F)+VALUE(SG_14.3_G)+VALUE(SG_14.3_H)+VALUE(SG_14.3_I)+VALUE(SG_14.3_J)+VALUE(SG_14.3_K)+VALUE(SG_14.3_L)
***SG_14_SCORE=VALUE(
IF((SG_14.3_SUM>=100)AND(SG_14.2_SUM>=100),"3",
IF((SG_14.2_SUM>=100)OR(SG_14.3_SUM>=100),"2",
IF(((SG_14.2_H=100)AND(SG_14.3_H=100))OR(SG_14.1_B<>100),"0", "0"))))
...
***V_SORT3=SUM_SORT(3, SG_08.a_SCORE, SG_08.b_SCORE, SG_11_SCORE,SG_14_SCORE,CM_01_SCORE,0,0,0,0)
...
***[Choice]Appeal approved for this indicator=RESPONSE("PRI reporting framework 2018: [Choice]Appeal approved for this indicator", "781b08d9dd5e4629aec2c3941250b598_34", SURVEY_ID)
***SG__Investment_Policy_score=SCORE("PRI reporting framework 2018: (SG__Investment_Policy) [Section]Investment policy", "bf735de92be04caa8c32fcbc25cbdd2c", SURVEY_ID)
...
***OO_PE 01.1_A7__Other_Investment_Strategy2=RESPONSE("PRI reporting framework 2018: (OO_PE 01.1_A7__Other_Investment_Strategy_Specify) [Radio]", "8668db82150e43bf9a2ab931cd90f88a_4", SURVEY_ID)
